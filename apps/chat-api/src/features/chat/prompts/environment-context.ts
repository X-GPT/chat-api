...
const COLLECTION_CONTEXT_TEMPLATE = [
	...
	"- You must use the available tools (list_collection_files, read_file, search_knowledge) to read the files in the collection before answering questions.",
	...
	"- DO NOT respond that information is missing until you have used at least one of read_file or search_knowledge and examined the results.",
	"- DO NOT use outside knowledge, general knowledge, or external information to answer questions.",
