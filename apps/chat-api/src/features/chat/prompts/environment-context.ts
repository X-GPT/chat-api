...
const COLLECTION_CONTEXT_TEMPLATE = [
	...
	"- You must use the available tools (list_collection_files, read_file) to read the files in the collection before answering questions.",
	...
	"- DO NOT respond that information is missing until you have used read_file and examined the results.",
	"- DO NOT use outside knowledge, general knowledge, or external information to answer questions.",
...
const ALL_FILES_CONTEXT_TEMPLATE = [
	...
	"- You MUST use the available tools (list_all_files, read_file) to find and read files before answering.",
